...
public class BackAndForth extends CommandOpMode {
    ...
    private FollowTrajectoryCommand forwardFollower, backwardFollower;
    ...
    public void initialize() {
        ...
        Trajectory forwardTrajectory = drive.trajectoryBuilder(new Pose2d())
                .forward(DISTANCE)
                .build();
        forwardFollower = new FollowTrajectoryCommand(drive, forwardTrajectory);
        backwardFollower = new FollowTrajectoryCommand(drive,
